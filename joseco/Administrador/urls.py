...
from .views import UsuarioListView, CursoListView, admin_dashboard, eliminar_usuario, CursoCreateView, eliminar_curso, lista_horarios, crear_horario, editar_horario, eliminar_horario, editar_curso, crear_usuario, editar_usuario
...
urlpatterns = [
    ...
    path('cursos/', CursoListView.as_view(), name='admin_cursos'),
